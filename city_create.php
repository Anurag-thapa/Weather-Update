...
if (isset($_POST['submit'])) {
  ...
  $preparedStm = $conn->prepare("INSERT INTO city_table (city_name, longitude, latitude) VALUES (?,?,?)");
  $preparedStm->bind_param("sss", $city_name, $longitude, $latitude);
                            ...
                            <div class="flex flex-wrap formbold--mx-3">
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        <label for="cityName" class="formbold-form-label"> City Name </label>
                                        <input type="text" name="city_name" id="temprature" placeholder="City Name"
                            ...
                            <div class="flex flex-wrap formbold--mx-3">
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        ...
                                        <input type="number" step="0.01" name="longitude" id="wind_speed"
                                            placeholder="00000.00" class="formbold-form-input" />
                                    </div>
                                </div>
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        <label for="longitude" class="formbold-form-label">Longitude </label>
                                        <input type="number" step="0.01" name="latitude" id="wind_speed"
                                            placeholder="00000.00" class="formbold-form-input" />
                                    </div>
                                </div>
                            </div>
